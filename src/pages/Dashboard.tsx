...
export function Dashboard() {
  const { totalBovines, totalHerds, byGender, byHerd } = useDashboardController();
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 font-sans pb-24 transition-colors duration-300">
      ...
      <div className="hidden md:flex justify-between items-center max-w-5xl mx-auto pt-8 px-4 mb-6">
         <h1 className="text-3xl font-bold text-neutral-800 dark:text-white">Visão Geral</h1>
         <SyncIndicator />
      </div>
      ...
      <main className="max-w-5xl mx-auto p-4 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-neutral-800 p-5 rounded-2xl border border-neutral-100 dark:border-neutral-700 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Total de Cabeças</span>
            </div>
            <div className="text-3xl font-bold text-neutral-900 dark:text-white">{totalBovines}</div>
          </div>
          ...
          <div className="bg-white dark:bg-neutral-800 p-5 rounded-2xl border border-neutral-100 dark:border-neutral-700 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Rebanhos Ativos</span>
            </div>
            <div className="text-3xl font-bold text-neutral-900 dark:text-white">{totalHerds}</div>
          </div>
          ...
          <div className="col-span-2 md:col-span-1 bg-gradient-to-br from-primary-600 to-primary-800 p-5 rounded-2xl shadow-lg text-white">
            ...
            <div className="text-xs opacity-70 mt-1">Neste mês (Simulado)</div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-neutral-800 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-700 shadow-sm">
            <h3 className="text-lg font-bold text-neutral-800 dark:text-white mb-6">Por Gênero</h3>
            <div className="h-64">
            ...
            <div className="flex justify-center gap-6 mt-4">
              {byGender.map((item) => (
                <div key={item.name} className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-neutral-600 dark:text-neutral-300">{item.name} ({item.value})</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-neutral-800 p-6 rounded-2xl border border-neutral-100 dark:border-neutral-700 shadow-sm">
            <h3 className="text-lg font-bold text-neutral-800 dark:text-white mb-6">Maiores Rebanhos</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={byHerd} layout="vertical" margin={{ left: 20 }}>
                  ...
                  <Tooltip 
                    ...
                    contentStyle={{ backgroundColor: '#333', border: 'none', borderRadius: '8px', color: '#fff' }}
                  />
                  <Bar dataKey="value" fill="rgb(var(--color-primary-500))" radius={[0, 4, 4, 0]} barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
